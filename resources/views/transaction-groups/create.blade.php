                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    @if ($organizations->isEmpty())
                        <div class="mb-4 rounded-md bg-yellow-100 text-yellow-800 px-4 py-2">
                            Nenhuma organizacao encontrada. Cadastre uma organizacao antes de criar grupo de transacao.
                        </div>
                    @endif

                    <form method="POST" action="{{ route('transaction-groups.store') }}" class="space-y-4">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="occurred_on" name="occurred_on" type="date" class="mt-1 block w-full"
                                :value="old('occurred_on')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="customer_installments" name="customer_installments" type="number"
                                min="1" class="mt-1 block w-full" :value="old('customer_installments', 1)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="flow_installments" name="flow_installments" type="number" min="1"
                                class="mt-1 block w-full" :value="old('flow_installments', 1)" required />
                        ...
                        <div class="flex items-center gap-2">
                            <input id="anticipation" name="anticipation" type="checkbox" value="1"
                                @checked(old('anticipation')) class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
