<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="organization_cnpj" class="block mt-1 w-full" type="text" name="organization_cnpj" :value="old('organization_cnpj')" required autocomplete="organization-tax-id" />
